...
///
/// The `Calc` type is used to represent CSS calculations that can combine different
/// units and perform mathematical operations on them.
///
...
impl Deref for Calc {
    ...
    /// Returns a reference to the inner calculation expression string.
    ///
...
impl DerefMut for Calc {
    /// Returns a mutable reference to the inner calculation expression string.
    ///
